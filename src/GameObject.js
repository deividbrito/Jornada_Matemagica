class GameObject {
  constructor(config) {
    ...
    this.sprite = new window.Sprite({  //o "sprite" dá a chamada de como um objeto deve parecer dentro da interface
      gameObject: this,
  ...
  async doBehaviorEvent(map) { 
    ...
    const eventHandler = new window.OverworldEvent({ map, event: eventConfig });
