...
// =============================================
// MAPAS DA CAMPANHA ENSINO MÉDIO (_M)
// =============================================
  ...
  Corredor_M: {
    ...
    gameObjects: {
      ...
      personagem: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Você precisa enfrentar os magos do Ensino Médio! Eles são mais poderosos..."},
            ]
          }
        ]
      }),
        ...
        talking: [
          {
            events: [
              { type: "changeMap",
                ...
                direction: "up",
                requireConfirmation: true,
                confirmationText: "Deseja ir até o pátio? O mago Probabilius te aguarda lá, com desafios de probabilidade e estatística!"
              },
            ]
          }
        ]
    ...
    cutsceneSpaces: {
      ...
      [utils.asGridCoord(0,12)]: [
        {
          events: [
            { type: "changeMap",
              ...
              direction: "up",
              requireConfirmation: true,
              confirmationText: "Deseja ir até a sala 2? O mago Trigonalis te desafiará com questões de trigonometria!"
            }
          ]
        }
      ],
      ...
      [utils.asGridCoord(9,12)]: [
        {
          events: [
            { type: "changeMap",
              ...
              requireConfirmation: true,
              confirmationText: `
              <b style="font-family: 'Courier New', monospace;">Mago Funcionalus:</b><br>
              Deseja ser desafiada no mundo das funções?`
            }
          ]
        }
      ],
      ...
      //acesso banheiro
      [utils.asGridCoord(0,27)]: [{ events: [{}] }],
      [utils.asGridCoord(0,28)]: [{ events: [{}] }],
      [utils.asGridCoord(0,29)]: [{ events: [{}] }],
      //acesso biblioteca
      [utils.asGridCoord(9,27)]: [
        {
          events: [
  ...
  Sala1_M: {
    ...
    gameObjects: {
      ...
      p4: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Cuidado com o Mago Funcionalus... ele domina todas as funções!"},
            ]
          }
        ]
      }),
        ...
        talking: [
          {
            required: ["DESAFIO1D3_COMPLETO"],
            events: [
              {type: "textMessage", text: "Mago Funcionalus: Impossível... minhas funções... foram todas resolvidas?"},
            ]
          },
          {
            required: ["DESAFIO1D2_COMPLETO"],
    ...
    cutsceneSpaces: {
      [utils.asGridCoord(13,19)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(8), y: utils.withGrid(13), direction: "left" }] }
      ],
      [utils.asGridCoord(14,19)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(8), y: utils.withGrid(13), direction: "left" }] }
      ],
  ...
  Sala2_M: {
        ...
        talking: [
          {
            required: ["DESAFIO2D3_COMPLETO"],
            events: [
              {type: "textMessage", text: "Mago Trigonalis: Seno, cosseno, tangente... nada foi suficiente contra você!"},
            ]
          },
          {
            required: ["DESAFIO2D2_COMPLETO"],
            events: [
              { type: "changeMap", map: "Desafio2d3", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
          {
            required: ["DESAFIO2D1_COMPLETO"],
            events: [
              { type: "changeMap", map: "Desafio2d2", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
          {
            events: [
              { type: "changeMap", map: "Desafio2d1", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
        ]
      }),
    ...
    cutsceneSpaces: {
      [utils.asGridCoord(13,19)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(1), y: utils.withGrid(13), direction: "right" }] }
      ],
      [utils.asGridCoord(14,19)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(1), y: utils.withGrid(13), direction: "right" }] }
      ],
        ...
        talking: [
          {
            ...
            events:[
              {type: "textMessage", text: "Alice: Professora, o que aconteceu com o Pedro?"},
              {type: "textMessage", text: "Professora: Os magos do Ensino Médio são muito mais poderosos. Pedro não aguentou a pressão dos desafios..."},
            ]
          },
          {
            events: [
              { type: "textMessage", text: "Alice: Professora! O que está acontecendo?", faceHero: "professora" },
              { type: "textMessage", text: "Professora: Alice, os magos do Ensino Médio tomaram conta da escola!"},
              { type: "textMessage", text: "Professora: Eles dominam funções, trigonometria, logaritmos e muito mais..."},
              { type: "textMessage", text: "Professora: Você precisa enfrentá-los e provar que domina a matemática do EM!"},
              { type: "textMessage", text: "Alice: Como venço esses desafios?"},
              { type: "textMessage", text: "Professora: Responda cada pergunta corretamente. Confie no que aprendeu!"},
              {type: "addStoryFlag", flag: "FALOU_COM_PROFESSORA"},
            ]
          }
        ]
        ...
        talking: [
          {
            required: ["FALOU_COM_PROFESSORA"],
            events: [
              {type: "textMessage", text:"Pedro: A-aqueles magos... funções, logaritmos... é demais pra mim...", faceHero: "npcA"},
              {type: "textMessage", text: "Alice: Pedro? Calma, vai ficar tudo bem!"},
              {type: "textMessage", text: "Pedro: ..."},
              {type: "addStoryFlag", flag: "FALOU_COM_PEDRO"},
            ]
          },
  ...
  Gremio_M: {
      ...
      vilao3: new Person({
        ...
        talking: [
          ...
          },
          {
            required: ["DESAFIO3D2_COMPLETO"],
            events: [
              { type: "changeMap", map: "Desafio3d3", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
          {
            required: ["DESAFIO3D1_COMPLETO"],
            events: [
              { type: "changeMap", map: "Desafio3d2", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
          {
            events: [
              { type: "changeMap", map: "Desafio3d1", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
        ]
      }),
    ...
    cutsceneSpaces: {
      [utils.asGridCoord(4,9)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(1), y: utils.withGrid(20), direction: "up" }] }
      ],
      [utils.asGridCoord(5,9)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(1), y: utils.withGrid(20), direction: "up" }] }
      ],
  ...
  Biblioteca_M: {
      ...
      vilao5: new Person({
        ...
        talking: [
          ...
          },
          {
            required: ["DESAFIO5D2_COMPLETO"],
            events: [
              { type: "changeMap", map: "Desafio5d3", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
          {
            required: ["DESAFIO5D1_COMPLETO"],
            events: [
              { type: "changeMap", map: "Desafio5d2", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
          {
            events: [
              { type: "changeMap", map: "Desafio5d1", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
        ]
      }),
    ...
    cutsceneSpaces: {
      [utils.asGridCoord(14,19)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(8), y: utils.withGrid(28), direction: "up" }] }
      ],
      [utils.asGridCoord(15,19)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(8), y: utils.withGrid(28), direction: "up" }] }
      ],
  ...
  Patio_M: {
    ...
    gameObjects: {
      ...
      p5: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "O mago Probabilius controla o acaso... cuidado com as estatísticas dele!"},
            ]
          }
        ]
      }),
      ...
      vilao6: new Person({
        ...
        talking: [
          ...
          },
          {
            required: ["DESAFIO6D2_COMPLETO"],
            events: [
              { type: "changeMap", map: "Desafio6d3", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
          {
            required: ["DESAFIO6D1_COMPLETO"],
            events: [
              { type: "changeMap", map: "Desafio6d2", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
          {
            events: [
              { type: "changeMap", map: "Desafio6d1", x: utils.withGrid(8), y: utils.withGrid(8), direction: "down" }
            ]
          },
        ]
      }),
    ...
    cutsceneSpaces: {
      [utils.asGridCoord(0,6)]: [
        { events: [{ type: "changeMap", map: "Jardim", x: utils.withGrid(14), y: utils.withGrid(7), direction: "down" }] }
      ],
      [utils.asGridCoord(0,7)]: [
        { events: [{ type: "changeMap", map: "Jardim", x: utils.withGrid(14), y: utils.withGrid(7), direction: "down" }] }
      ],
      ...
      [utils.asGridCoord(5,19)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(4), y: utils.withGrid(3), direction: "down" }] }
      ],
      [utils.asGridCoord(6,19)]: [
        { events: [{ type: "changeMap", map: "Corredor", x: utils.withGrid(4), y: utils.withGrid(3), direction: "down" }] }
      ],
  ...
  Jardim_M: {
    ...
    gameObjects: {
      ...
      p3: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "O mago Matricius está ali... ele manipula matrizes e determinantes!"},
            ]
          }
        ]
      }),
    ...
    cutsceneSpaces: {
      [utils.asGridCoord(15,7)]: [
        { events: [{ type: "changeMap", map: "Patio" }] }
      ],
      [utils.asGridCoord(15,8)]: [
        { events: [{ type: "changeMap", map: "Patio" }] }
      ],
